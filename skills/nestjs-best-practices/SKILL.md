...
1. Identify the relevant rule from the quick reference above.
2. Read `rules/<rule-name>.md` for examples and explanations.
3. Use `rules/_sections.md` for category metadata when needed.

Each rule file contains incorrect/correct code examples and context.
